...
RUN dnf -y install buildah slirp4netns iputils podman-docker python3.11 go maven-openjdk11.noarch npm nodejs git fuse-overlayfs --exclude container-selinux
